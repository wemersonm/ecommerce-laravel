...
class Installment
{
    ...
    public function __construct(public int $parcels = 8, public float $forward_price = 0.0)
    {
...
class CartCalculator
{
    ...
    public function __construct(private $cart)
    {
        ...
        $this->intallments = new Installment((int) getNumberParcels($this->forward_price_products), $this->forward_price_products);
    }
